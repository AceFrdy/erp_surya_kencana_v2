    ...
    return (
        <div>
            ...
            <div className="panel mt-6">
                <h1 className="text-lg font-bold flex justify-center">Data Piutang</h1>
                ...
                <div className="datatables panel xl:col-span-2">
                    <DataTable
                        ...
                        columns={[
                            ...
                            // { accessor: 'phone', title: 'Nominal', sortable: true },
                            {
                                accessor: 'progress',
                                title: 'Progress',
                                sortable: true,
                                ...
                                render: () => (
                                    <div className="flex items-center w-max mx-auto gap-2">
                                        <button type="button" style={{ color: 'blue' }}>
                                            <Link to="/menukeuangan/hutang-piutang/detailpiutang">
                                                <IconNotes className="ltr:mr-2 rtl:ml-2 " />
                                            </Link>
                                        </button>
                                        <button type="button" style={{ color: 'orange' }}>
                                                <Link to="/menukeuangan/hutang-piutang/editpiutang">
